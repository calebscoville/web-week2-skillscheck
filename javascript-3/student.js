...
//////////////////STEP 4////////////////////
//Create a function called 'addItem' that takes in one paramater called item. 
// Add the item param to the end of the groceries array created above. Inside of 
// addItem, invoke displayData() which is a function we created that takes care of 
// some of the leg work unrelated to this module.

function addItem(x) {
    setGroceryListTitle.push(x)
}

//////////////////STEP 5////////////////////
//Create a function called removeItem that takes in one paramater called index. 
